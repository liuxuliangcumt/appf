...
abstract class BaseUtil {
  static final GlobalKey<NavigatorState> gNavigatorKey = new GlobalKey<NavigatorState>();
  // 阅读并同意用户协议和隐私政策
  ...
  // 发布路径
  static String gBaseHost = 'app.cylon.top';
  static String gBasePort = '8082';
//  本地开发测试路径
//   static String gBaseHost = '192.168.2.4';
//   static String gBasePort = '8082';
  static String gBaseUrl = '${BaseUtil.gBaseSchema}://${BaseUtil.gBaseHost}:${BaseUtil.gBasePort}';
  // 默认主题色
  ...
  static final double gStatusBarHeight = MediaQueryData.fromWindow(window).padding.top;
  ...
  static List<String> gArrFollow = ['刘备', '关羽', '张飞', '赵云', '黄忠', '马超', '诸葛亮', '曹操', '孙权', '董卓', '吕布'];
  static String gDefaultAvatar = "https://www.reciprocalaffection.com/uploads/DongGanDanChe/default.jpg";
  static String gDefaultImage = "https://www.reciprocalaffection.com/uploads/DongGanDanChe/default.jpg";
  ...
  static num dp(double dessignValue) => ScreenUtil().setWidth(dessignValue);
  ...
  static var gArrArtWordColor = [
    { "text": Color(0xFFFFF700), "shadowLeftTop": Color(0xFFFF7800), "shadowRightBottom": Color(0xAAFF0000), },
    { "text": Color(0xFFe54d42), "shadowLeftTop": Color(0xFF9c26b0), "shadowRightBottom": Color(0xAA6739b6), },
    { "text": Color(0xFFf37b1d), "shadowLeftTop": Color(0xFF9c26b0), "shadowRightBottom": Color(0xAA6739b6), },
    { "text": Color(0xFFfbbd08), "shadowLeftTop": Color(0xFF9c26b0), "shadowRightBottom": Color(0xAA6739b6), },
    { "text": Color(0xFFa5673f), "shadowLeftTop": Color(0xFF9c26b0), "shadowRightBottom": Color(0xAA6739b6), },
  ];
