...
class _DongGanDanCheAppState extends State<DongGanDanCheApp> {
  ...
  Route<dynamic> buildRoute(RouteSettings settings) {
    Map<String, WidgetBuilder> routes = {
      ...
      '/AgoraLive': (BuildContext context) => AgoraLivePage(arguments: settings.arguments),
      '/PlayVideo': (BuildContext context) => PlayVideoPage(arguments: settings.arguments),
      '/liveClose': (BuildContext context) => DongGanDanCheLiveClose(),
      '/index': (BuildContext context) => DongGanDanCheIndexPage(arguments: settings.arguments),
      '/match/edit': (BuildContext context) => DongGanDanCheMatchEditInfo(arguments: settings.arguments),
      '/match/detail': (BuildContext context) => DongGanDanCheMatchDetailPage(arguments: settings.arguments),
      '/match/room': (BuildContext context) => DongGanDanCheMatchRoomPage(arguments: settings.arguments),
      '/match/result': (BuildContext context) => DongGanDanCheMatchResultPage(arguments: settings.arguments),
      '/recharge': (BuildContext context) => DongGanDanCheRechargePage(arguments: settings.arguments),
    };
