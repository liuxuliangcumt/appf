...
class _AdminBasePage extends State<AdminBasePage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (strTitle != "") {
      ...
      arrMainWidget.add(Padding(padding: EdgeInsets.only(top: BaseUtil.dp(10))));
      arrMainWidget.add(Expanded(
        flex: 1,
        child: dataWidget
      ));
    }
    return Container(
      ...
      child: Stack(
        children: [
          Container(
            padding: EdgeInsets.fromLTRB(BaseUtil.dp(20), BaseUtil.dp(60), BaseUtil.dp(20), BaseUtil.dp(30)),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: Colors.white,
              borderRadius: BorderRadius.only(topLeft: Radius.circular(BaseUtil.dp(20)), topRight: Radius.circular(BaseUtil.dp(20)))
            ),
            child: Column(
  ...
  Widget _buildAvatar(BuildContext context) {
    var str = BaseUtil.gStUser["avatar"] == null || BaseUtil.gStUser["avatar"] == "" ? "" : BaseUtil.gBaseUrl + BaseUtil.gStUser["avatar"];
    return Container(
      height: 68,
      width: 68,
      decoration: BoxDecoration(
              ...
              child: Column(
                children: [
                  Container(
                    alignment: Alignment.centerLeft,
                    child: Text(
                      BaseUtil.gStUser.containsKey("nickName") ? BaseUtil.gStUser["nickName"] : "你居然没有名字",
                      maxLines: 1,
                  ...
                  Container(
                    alignment: Alignment.centerLeft,
                    child: Text(
                      BaseUtil.gStUser.containsKey("remark") ? BaseUtil.gStUser["remark"] : "这个家伙很懒，什么也没有留下",
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                      style: TextStyle(
                          color: Colors.white,
      ...
      children: [
        GestureDetector(
          ...
          child: Row(
            children: [
              Text(
                BaseUtil.gStUser["fansNum"] == null ? "0" : BaseUtil.gStUser["fansNum"].toString(),
                style: TextStyle(
                  color: Colors.white,
        ...
        GestureDetector(
          ...
          child: Row(
            children: [
              Text(
                BaseUtil.gStUser["followNum"] == null ? "0" : BaseUtil.gStUser["followNum"].toString(),
                style: TextStyle(
                  color: Colors.white,
                  fontSize: BaseUtil.dp(27),
                  fontWeight: FontWeight.bold,
          ...
          child: Column(
            children: [
              Container(
                ...
                child: Image.asset("assets/images/admin/collection.png", fit: BoxFit.cover),
              ),
              Text(
                "我的收藏",
                style: TextStyle(
          ...
          child: Column(
            children: [
              Container(
                width: BaseUtil.dp(42),
                height: BaseUtil.dp(42),
                child: Image.asset("assets/images/admin/pay.png", fit: BoxFit.cover),
              ),
              Text(
                "交易记录",
                style: TextStyle(
          ...
          child: Column(
            children: [
              Container(
                width: BaseUtil.dp(42),
                height: BaseUtil.dp(42),
                child: Image.asset("assets/images/admin/interact.png", fit: BoxFit.cover),
              ),
              Text(
                "互动记录",
                style: TextStyle(
          ...
          child: Column(
            children: [
              Container(
                width: BaseUtil.dp(42),
                height: BaseUtil.dp(42),
                child: Image.asset("assets/images/admin/setting.png", fit: BoxFit.cover),
              ),
              Text(
                "个人设置",
                style: TextStyle(
    ...
    return ScrollConfiguration(
      ...
      child: RefreshConfiguration(
        ...
        child: SmartRefresher(
          ...
          onRefresh: () { DongGanDanCheService.onRefresh("Video", { "userId": BaseUtil.gStUser['id'] }, _refreshController); },
          onLoading: () { DongGanDanCheService.onLoading("Video", { "userId": BaseUtil.gStUser['id'] }, _refreshController); },
                ...
                child: Container(
                  child: Column(
                    children: [
                      ...
                      VideoListPage("Video", BaseUtil.gStUser['id'], _refreshController)
                    ],
                  ),
                ),
              )
  ...
  Widget _buildSportInfo() {
    var exerciseDays = BaseUtil.gStUser["exerciseDays"] == null ? "0" : BaseUtil.gStUser["exerciseDays"];
    var exerciseTime = BaseUtil.gStUser["exerciseTime"] == null ? 0 : BaseUtil.gStUser["exerciseTime"];
    var exerciseCount = BaseUtil.gStUser["exerciseCount"] == null ? "0" : BaseUtil.gStUser["exerciseCount"];

    return Container(
      alignment: Alignment.topLeft,
      padding: EdgeInsets.only(top: BaseUtil.dp(5), left: BaseUtil.dp(20), right: BaseUtil.dp(20)),
      child: Row(
        children: [
          GestureDetector(
            child: Column(
