...
class DongGanDanCheHeader extends StatefulWidget {
  ...
  DongGanDanCheHeader({ this.addCallBack, this.searchCallBack, this.height, this.opacity = 1.0, this.decoration });
    ...
    if (BaseUtil.gStUser["userType"] == 101) {
      arrRowChild.add(GestureDetector(
        ...
        child: Container(
          ...
          child: Icon(Icons.add, size: 40, color: Color(0xFF333333),),
        ),
      ));
    }
